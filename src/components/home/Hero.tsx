...
const Hero:React.FC = () => {
    ...
    return (
        ...
        <div style={{background:"linear-gradient(92.17deg, #673DE6 -0.69%, #C913CD 122.6%)", backgroundImage: "url(/img/herobg.png)", backgroundSize: "cover", backgroundPositionY: viewWidth >= 1468 ? -380:0}} className="h-[586px] rounded-[9px] flex items-center justify-center">
